...
class CVoronoiDiagramGenerator
{
public:
	CVoronoiDiagramGenerator();
	~CVoronoiDiagramGenerator();

	bool generateVoronoi(struct VoronoiSourcePoint* srcPoints, int numPoints, float minX, float maxX, float minY, float maxY, float minDist=0);
...
private:
	...
	int ccw( VPoint p0, VPoint p1, VPoint p2 );
